...
class pdd:
    def __init__(self, Y: np.ndarray, W: np.ndarray, D: np.ndarray, Z: np.ndarray, cutoff=0.0, alpha=0.05, kernel='gaussian', dtype = torch.float32, device = 'cpu', seed = 10042002):
